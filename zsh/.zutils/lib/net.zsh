...
: <<=cut
=item Function C<net::_port_open>
...
Example:
  net::_port_open 127.0.0.1 80
  net::_port_open 127.0.0.1 80 90
  net::_port_open 127.0.0.1 80-90

@return 0 if the port is open on specified host, 1 otherwise.
=cut
function net::_port_open() {
