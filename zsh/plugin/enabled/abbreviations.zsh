...
abbrev-alias -c miwifi='ssh root@miwifi'
abbrev-alias -c juanwang='ssh juanwang@juanwang'
abbrev-alias -c lede='ssh root@lede'
abbrev-alias -c ts551='ssh admin@ts551'
abbrev-alias -c ts212='ssh admin@ts212'
