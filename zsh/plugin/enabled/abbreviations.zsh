...
abbrev-alias -c pi='ssh -i ~/.ssh/paulhybryant pi@pi'
abbrev-alias -c miwifi='ssh -i ~/.ssh/paulhybryant root@mifiwi'
abbrev-alias -c vps='ssh -i ~/.ssh/paulhybryant root@www.paulhybryant.tk'
abbrev-alias -c nas='ssh -i ~/.ssh/paulhybryant admin@paulhybryant.myqnapcloud.com'
