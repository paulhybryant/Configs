...
if isdirectory(s:bundle_base_path . 'neobundle.vim/')
  ...
  " }}}
  " {{{2
  NeoBundle 'google/vim-codefmt', {'on_ft' : ['cpp', 'javascript', 'sql', 'xml', 'json', 'python']}      " Code formating plugin from google, python formatter: https://github.com/google/yapf, java formatter: https://github.com/google/google-java-format
