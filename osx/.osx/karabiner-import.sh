...
/bin/echo -n .
$cli set remap.pc_fn_h2down_arrow 1
/bin/echo -n .
...
/bin/echo -n .
$cli set private.control_1_switch_to_tab1 1
/bin/echo -n .
$cli set repeat.wait 33
/bin/echo -n .
$cli set remap.pcstyle_close 1
/bin/echo -n .
$cli set private.control_1_switch_to_tmux_window1 1
/bin/echo -n .
$cli set remap.new_winstyle_no_term 1
/bin/echo -n .
$cli set remap.pc_fn_h2up_arrow 1
/bin/echo -n .
$cli set private.control_1_switch_to_iterm2_tab1 1
/bin/echo -n .
$cli set remap.vimnormal_ctrlbracketleft_toggle2 1
/bin/echo -n .
$cli set remap.pc_fn_l2right_arrow 1
/bin/echo -n .
$cli set remap.pc_fn_h2left_arrow 1
/bin/echo -n .
$cli set remap.pc_style_open 1
/bin/echo -n .
$cli set remap.app_google_chrome_controlL2commandL 1
/bin/echo -n .
$cli set remap.undo_winstyle_no_term 1
/bin/echo -n .
$cli set remap.pc_application_l2right_arrow 1
/bin/echo -n .
$cli set remap.pc_application_h2left_arrow 1
/bin/echo -n .
$cli set remap.save_winstyle_no_term 1
/bin/echo -n .
$cli set remap.copy_paste_winstyle_new_tab 1
/bin/echo -n .
$cli set private.command_l_hl_to_alt_l_hl 1
/bin/echo -n .
